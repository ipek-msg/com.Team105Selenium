    ...
    public static void main(String[] args) throws InterruptedException {
       ...
       //  7- Birthday butonuna basin
        driver.findElement(By.xpath("//a[@aria-label='Birthday']")).click();
          //driver.findElement(By.cssSelector("a[@aria-label='Birthday']")).click(); CSSSELECTOR DENEDİK PEK UYGUN OLMADI KOD ÇALIŞMADI XPATH PERFECT
       ...
       //  10-Urun ucretinin 25$ oldugunu test edin
        ...
        //ön görü yapabilmek icinSystem.out.println(urunucretElementi.getText());
