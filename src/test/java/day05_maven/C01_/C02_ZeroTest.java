...
//6. navigate back yapıp online banking üzerinden Pay Bills sayfasina gidin
...
//10. “The payment was successfully submitted.” mesajinin ciktigini test edin
        WebElement succesfulyElementi= driver.findElement(By.id("alert_content"));
        if (succesfulyElementi.isDisplayed()){
